<?php
// este arquivo é um arquivo sigiloso, mas como contém apenas testes, foi deixado na pasta dentro do próprio app para questão de visualização no github
...
try {
    ...
    $mail->Username   = 'email_remetente@email.com';                     //SMTP username
    $mail->Password   = 'senha_email_remetente';                               //SMTP password
